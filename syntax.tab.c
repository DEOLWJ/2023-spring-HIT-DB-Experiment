...
{
       0,    59,    59,    65,    70,    81,    93,   100,   105,   112,
     117,   127,   134
};
#endif
...
{
  "$end", "error", "$undefined", "SELECT", "PROJECTION", "JOIN", "ID",
  "LP", "RP", "LB", "RB", "AND", "COMMA", "APOS", "ASSIGNOP", "$accept",
  "Program", "Whole", "WholeX", "Conditions", "Condition", "Attributes", YY_NULLPTR
};
#endif
...
{
      -2,    -6,     2,   -11,     7,     5,   -11,     6,     8,   -11,
      -2,     3,     9,     4,    10,    11,     5,    12,    13,     6,
       8,    16,    18,    -2,   -11,   -11,    -2,    14,     0,     1,
     -11,   -11,   -11
};
...
{
      16,     1,     2,     7,     3,    10,    10,     9,    31,    32,
      10,     8,    11,    28,    14,    19,    29,    17,    24,    18,
      23,    21,    20,    26,    27,    22,     0,    30,     0,     0,
       0,     0,     0,     0,     0,    25
};

static const yytype_int8 yycheck[] =
{
      10,     3,     4,     9,     6,     5,     5,     0,     8,     8,
       5,     9,     6,    23,     6,    11,    26,    14,    19,    10,
       7,    10,    12,     7,     6,    13,    -1,    13,    -1,    -1,
      -1,    -1,    -1,    -1,    -1,    20
};
...
{
       0,     3,     4,     6,    16,    17,    18,     9,     9,     0,
       5,     6,    19,    20,     6,    21,    17,    14,    10,    11,
      12,    10,    13,     7,    19,    21,     7,     6,    17,    17,
      13,     8,     8
};
...
yyreduce:
  ...
  case 2:
#line 59 "syntax.y"
               {	yyval = CreateNode(4,1,(yyloc).first_line);
			yyval->name = "Program";
...
#line 70 "syntax.y"
                                             {
				yyval = CreateNode(4,7,(yyloc).first_line);
				yyval->name = "Whole";
...
#line 93 "syntax.y"
                         {
				yyval = CreateNode(4,3,(yyloc).first_line);
				yyval->name = "WholeX";
...
#line 117 "syntax.y"
                                    {
				yyval = CreateNode(4,5,(yyloc).first_line);
				yyval->name = "Condition";
